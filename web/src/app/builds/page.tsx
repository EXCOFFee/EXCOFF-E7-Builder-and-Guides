                ...
                <div className="mb-8 space-y-4 bg-e7-panel p-4 rounded-lg border border-white/6">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        >
                            ...
                            <option value="views_desc">早 {t('common.viewsHigh', 'Views (High)')}</option>
                            <option value="views_asc">早 {t('common.viewsLow', 'Views (Low)')}</option>
                            <option value="likes_desc">笶､ {t('common.likesHigh', 'Likes (High)')}</option>
                            <option value="likes_asc">笶､ {t('common.likesLow', 'Likes (Low)')}</option>
                        </select>
                        ...
                        >
                            笞呻ｸ・{t('builds.advancedFilters', 'Advanced Filters')}
                        </button>
                    </div>

            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    <Link href="/guilds" className="text-e7-gold hover:text-e7-text-gold text-sm mb-2 inline-flex items-center gap-2 group transition-colors">
                        <span className="group-hover:-translate-x-1 transition-transform">竊・/span> {t('guilds.backToList', 'Back to Guild Posts')}
                    </Link>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <div className="text-gray-400">
                                        胴 {t('guilds.clickToUpload', 'Click to upload images')}
                                    </div>
                                </div>

AGENTS.md - Contexto y Reglas Maestras para Agentes de IA (SIPREGO)
...
LA VERDAD: Este archivo (AGENTS.md) y el SRS (SRS_SIPREGO_SmartRetail_Final.md) son la ley. El Usuario (Yo) NO tiene la verdad absoluta.
...
Nombre: SIPREGO (Smart Retail & Logistics System).
